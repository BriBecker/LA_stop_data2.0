...
```{r, proportional_diff_test_plot, dev = 'png'}
...
The entire set of 25 divisions:
```{r, total_test}
total_df <- race_sum %>% 
  ungroup() %>% 
...
Again, Divisions listed near the top show significant p values; That is, the blue divisions would be divisions that we would want to analze more closely for appearances of racial discrimination.
```{r, p_value_results, dev='png'}
grid.arrange(
